...
tanach = pd.read_pickle('./tanach.pickle')
...
plt.savefig('./gematria_torah.jpg', dpi=300)
plot_colormesh(np.array(neviim))
plt.savefig('./gematria_neviim.jpg', dpi=300)
plot_colormesh(np.array(ketubim))
plt.savefig('./gematria_ketubim.jpg', dpi=300)
# plt.show(block=True)
